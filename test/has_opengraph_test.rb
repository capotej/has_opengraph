...
class HasOpengraphTest < Test::Unit::TestCase
  ...
  def setup
    ...
    @movie.descr = "Steve Segal tears it up"
    @movie.save
  end


  def test_graph_fetch
    example = '<meta property="og:type" content="movie"/><meta property="og:description" content="Steve Segal tears it up"/><meta property="og:title" content="Under Siege 2"/><meta property="og:url" content="http://moviesite.com/movies/under-siege-2"/><meta property="og:site_name" content="moviesite.com"/><meta property="og:image" content="http://path/to/image.jpg"/>'
